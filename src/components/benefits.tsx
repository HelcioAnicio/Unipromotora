      ...
      <div className="m-auto flex w-full max-w-xl flex-col items-center gap-5 px-1 md:p-10 2xl:max-w-3xl">
        ...
        <div className="flex w-full max-w-3xl items-center gap-2 rounded-4xl bg-[#FAFCFB] p-3 sm:py-5">
          ...
          <p className="w-full">
            ...
            <span className="font-bold"> tudo 100% digital</span>
          </p>
        </div>
        <div className="flex w-full max-w-3xl items-center gap-2 rounded-4xl bg-[#FAFCFB] p-3 sm:py-5">
          <FaHandHoldingDollar className="size-11 rounded-full bg-[#00FF75] p-2 text-black" />
          <p className="w-full">
            <span className="font-bold">Crédito que cabe no seu bolso </span>e
            com aprovação facilitada, inclusive para negativados
          </p>
        </div>
        <div className="flex w-full max-w-3xl items-center gap-2 rounded-4xl bg-[#FAFCFB] p-3 sm:py-5">
        ...
        <div className="flex w-full max-w-3xl items-center gap-2 rounded-4xl bg-[#FAFCFB] p-3 sm:py-5">
          ...
          <p className="w-full">
            Contrate crédito com parcelar a
            <span className="font-bold"> partir de 61 reais </span>
